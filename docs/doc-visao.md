...
| RF11 | Manter Plano de Iteração e Plano de Release | O sistema deve permitir o cadastro do plano de iteração e plano de release, assim como a visualização, alteração e exclusão. Um plano de iterações tem *dono*, *lista de projetos* e uma *lista de iterações*. Um plano de release tem *dono*, *lista de projetos* e uma *lista de releases*.  | Aluno/Professor. |
