...
| RF10 | Manter Atividade | O sistema deve permitir o cadastro de atividades para o projeto, assim como a alteração, visualização e exclusão destas. | Professor/Aluno. Uma atividade tem *código*, *nome*, *descrição*, *situação*, *data de início*, *data de conclusão*, *projeto*, *responsável*. |
